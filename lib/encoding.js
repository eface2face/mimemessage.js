...
const encodeBase64 = (value) => wraplines(base64encode(encodeUTF8(value)));
const decodeBase64 = (value) => decodeUTF8(base64decode(value));
 ...
 */
const encodeQP = (binarydata) =>
    encodeQPTrailingSpace(wrapQPLines(normalLinebreaks(encodeQPSequences(encodeUTF8(binarydata)))));

const removeSoftBreaks = (value) => value.replace(/=(\r\n|\n|\r)|/g, '');

const decodeQuotedPrintables = (value) =>
    value.replace(/=([0-9A-F][0-9A-F])/gm, (match, contents) => {
